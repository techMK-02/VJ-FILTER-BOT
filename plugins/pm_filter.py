    ...
    if query.data.startswith("file"):
     ...
     #   if not search:
      ...
      #      return
        ...
        buttons = [[
            InlineKeyboardButton('📩 Share', callback_data=f'https://t.me/share/url?url=https://telegram.me/{temp.U_NAME}?start=VJ-{query.from_user.id}'),
	    InlineKeyboardButton('◀️ Back', url='start'),
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://files.catbox.moe/2qhsy2.jpg")
        )
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        btn = [[
            ...
            InlineKeyboardButton("ᴜʀᴅᴜ ", callback_data="urdu_info"),
        ...
        btn = [[
            InlineKeyboardButton("📷sᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ sᴄʀᴇᴇɴsʜᴏᴛ📸", url="https://t.me/icrunchbot")
	],[
            InlineKeyboardButton("🏷️ᴘʀᴏᴏғs", url="telegram.me/FilmyWabX"),
	    InlineKeyboardButton("ʀᴀᴛᴇs 📉", url="https://telegra.ph/Other-Plans-04-26")
	],[
